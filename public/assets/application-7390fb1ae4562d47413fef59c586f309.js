...
var locations = [ [49.249783, -123.155250, 
                    "Arbutus Village Park", 4202, "Valley Drive",
                    ["Playgrounds"]],

                    [49.256555, -123.171406, 
                    "Carnarvon Park", 2995, "W 19th Avenue",
                    ["Field Houses", "Playgrounds", "Softball",
                    "Baseball Diamonds", "Football Fields", "Soccer Fields"]],
                    
                    [49.2611, -123.2531,
                    "UBC", 2329, "West Mall",
                    ["Cool shit", "Sauder", "Coyotes", "Comp Sci"]],

                    [49.239181, -123.131293,
...
function initializemap(locations) {
  ...
  var mapOptions = {
    center: new google.maps.LatLng(49.2627, -123.1207),
    zoom: 12,
    styles: style
  };
  ...
  navigator.geolocation.getCurrentPosition(function (position) {
    ...
    google.maps.event.addListener(userLocationMarker, 'click', (function(userLocationMarker) {
      return function() {
        infoWindow.setContent("<h1>You are here! :D</h1><h3>isn't that cool?</h3><p>we're stalking you</p>");
  ...
  for (i = 0; i < locations.length; i++) {
    ...
    google.maps.event.addListener(marker, 'click', (function(marker, i) {
      return function() {
        infoWindow.setContent( returnContent(locations, i));
